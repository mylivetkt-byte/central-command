...
import { Wallet, Clock, X, Check, Bike } from "lucide-react";
              ...
              {/* Timer ring */}
                <div className="relative pt-6 pb-2 flex flex-col items-center">
                  <div className="relative h-28 w-28">
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center">
                      <Bike className="h-6 w-6 text-green-600 mb-0.5" />
                  ...
                  <p className="mt-3 text-[10px] font-black text-green-600 uppercase tracking-[0.3em] animate-pulse">⚡ Nuevo pedido</p>
                </div>
                ...
                <div className="px-6 pb-6 space-y-4">
                  ...
                  <div className="relative space-y-4 px-1 py-1">
                    ...
                    <div className="flex items-start gap-4 relative">
                      <div className="h-3.5 w-3.5 rounded-full bg-green-600 border-4 border-white mt-1 shadow-sm" />
                      <div className="flex-1 min-w-0">
                        <p className="text-[9px] font-black text-green-700 uppercase tracking-[0.2em] mb-0.5">Entrega</p>
